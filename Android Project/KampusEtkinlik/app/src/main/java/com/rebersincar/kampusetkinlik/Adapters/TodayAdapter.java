...
public class TodayAdapter extends BaseAdapter{
    ...
    public TodayAdapter(List<TodayPojo> list,Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (list.get(position).isTf())
        {
            ...
            kategori.setText(SelectKategoriActivity.Categories[Integer.valueOf(list.get(position).getKategori())-1]);
